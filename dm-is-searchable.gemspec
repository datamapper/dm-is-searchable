...
Gem::Specification.new do |s|
  s.name = "dm-is-searchable"
  s.version = "1.2.0.rc1"

  s.required_rubygems_version = Gem::Requirement.new("> 1.3.1") if s.respond_to? :required_rubygems_version=
  s.authors = ["Bernerd Schaefer"]
  s.date = "2011-09-09"
  s.description = "A DataMapper plugin for searching"
  ...
  s.homepage = "http://github.com/datamapper/dm-is-searchable"
  s.require_paths = ["lib"]
  s.rubyforge_project = "datamapper"
  s.rubygems_version = "1.8.10"
  s.summary = "A DataMapper plugin for searching"
